...
def build_model(cfg):
    ...
    if (
        ...
        or model_name == "resunet2d"
        or model_name == "monotrack"
    ):
        ...
        model = __factory[model_name](
            frames_in * 3, frames_out, bilinear=bilinear, halve_channel=halve_channel
        )
    elif (
        model_name == "higher_hrnet"
        or model_name == "cls_hrnet"
        or model_name == "hrnet"
