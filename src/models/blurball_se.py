...
class BlurBall_SE(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.layer1 = self._make_layer(
            block, self._stem_inplanes, num_channels, num_blocks
        )
...
if __name__=='__main__':
    ...
    config_path = '/root/src/configs/model/higher_hrnet_w32.yaml'
    ...
    x = torch.rand((batch_size, 3*frames_in, 288, 512))
    print(x.shape)
    y = model(x)
