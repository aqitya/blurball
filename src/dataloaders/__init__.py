...
def build_dataloader(
    ...
    for key, clip_dataset in train_clip_datasets.items():
        ...
        train_clip_loaders_and_gts[key] = {
            "clip_loader": clip_loader,
            "clip_gt": dataset.train_clip_gts[key],
        }
    ...
    for key, clip_dataset in test_clip_datasets.items():
        ...
        test_clip_loaders_and_gts[key] = {
            "clip_loader": clip_loader,
            "clip_gt": dataset.test_clip_gts[key],
        }
